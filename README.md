...
Je l'ai créé, à l’origine, pour remplacer l'appli CLI pour Linux officiel. Codé pour mon usage personnel sur `Pop!_OS`un derivé de `Ubuntu`, et je le partage tel quel pour dépanner. 
